...
/*   Updated: 2022/08/04 16:42:44 by lmasato-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line_bonus.h"

char	*ft_next_line(int fd, char *buffer, char **r);
char	*ft_read_buffer(int fd, char *buffer, char **r, ssize_t *b);
char	*ft_split_line(char *src, char **r);
char	*error_handler(char **s);
